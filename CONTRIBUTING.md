...
3. **Understand the system** — read the [OpenSIN-AI organization profile](https://github.com/OpenSIN-AI) to see where your contribution fits.
...
- **Need to discuss an idea?** Start a Discussion.
- **Need setup guidance?** See [dev-setup](https://github.com/OpenSIN-AI/dev-setup).
- **Need collaboration flow help?** Read the [GitHub Collaboration Guide](https://github.com/OpenSIN-AI/dev-setup/blob/main/github/github-collaboration-readme.md).
